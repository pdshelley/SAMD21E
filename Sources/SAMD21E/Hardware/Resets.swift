  ...
  public struct Resets {
    ...
    public struct Reset {
      ...
      public func set(_ value: ResetValue) {
        SAMD21EHardware.write(value.rawValue, to: unsafeAddress | SAMD21EHardware.setAliasMask)
      }

      public func clear(_ value: ResetValue) {
        SAMD21EHardware.write(value.rawValue, to: unsafeAddress | SAMD21EHardware.clearAliasMask)
      }
    }
    ...
    public struct ResetDone {
      ...
      public var value: ResetValue {
        ResetValue(rawValue: SAMD21EHardware.read(UInt32.self, from: unsafeAddress))
      }
    }
  }
}
