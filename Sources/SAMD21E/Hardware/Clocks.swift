...
extension SAMD21EHardware {
  ...
  public struct Clocks {
    ...
    public struct Reference {
      ...
      public struct Control {
        ...
        public func modify<T>(_ apply: (inout Projection) -> T) -> T {
          let value = SAMD21EHardware.read(UInt32.self, from: unsafeAddress)
          var projection = Projection(decoding: value)
          let result = apply(&projection)
          SAMD21EHardware.write(projection.encoded, to: unsafeAddress)
          return result
        }

        public func set(_ projection: Projection) {
          SAMD21EHardware.write(projection.encoded, to: unsafeAddress | SAMD21EHardware.setAliasMask)
        }

        public var value: Projection {
          Projection(decoding: SAMD21EHardware.read(UInt32.self, from: unsafeAddress))
        }

        public func clearSource() {
          SAMD21EHardware.write(UInt32(0x00000001), to: unsafeAddress | SAMD21EHardware.clearAliasMask) 
        }

        public func clearReference() {
          SAMD21EHardware.write(UInt32(0x00000800), to: unsafeAddress | SAMD21EHardware.clearAliasMask) 
        }
      }
      ...
      public struct Divisor {
        ...
        public func setRawValue(_ value: UInt32) {
          SAMD21EHardware.write(value, to: unsafeAddress)
        }
      }

      public var selected: Bool {
        SAMD21EHardware.read(UInt32.self, from: unsafeAddress + 0x0038) != 0
      }
    }
    ...
    public struct System {
      ...
      public var selected: Bool {
        SAMD21EHardware.read(UInt32.self, from: unsafeAddress + 0x0044) != 0
      }
    }
